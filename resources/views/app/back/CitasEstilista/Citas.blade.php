                ...
                <table class="table table-hover align-middle">
                    <thead class="bg-light text-secondary">
                        <tr>
                            ...
                            <th class="border-0 text-center">ID Mascota</th>
                             <th class="border-0 text-center">ID Empleado</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold">{{ $cita->fecha_hora }}</td>
                            <td>{{ $cita->estado }}</td>
                            <td class="text-center">
                                <span class="badge bg-light text-dark border">{{ $cita->id_cliente }}</span>
                            </td>
                            <td class="text-center">
                                <span class="badge bg-light text-dark border">{{ $cita->id_mascota }}</span>
                            </td>
                            <td class="text-center">
                                <span class="badge bg-light text-dark border">{{ $cita->id_empleado }}</span>
                            </td>
